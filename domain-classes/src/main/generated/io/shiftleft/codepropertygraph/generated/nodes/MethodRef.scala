...
class MethodRefDb(ref: NodeRef[NodeDb]) extends NodeDb(ref) with StoredNode with Expression with MethodRefBase {
  ...
  def matchesIn: Iterator[StoredNode] = createAdjacentNodeScalaIteratorByOffSet[StoredNode](18)
  override def _matchesIn             = createAdjacentNodeScalaIteratorByOffSet[StoredNode](18)
